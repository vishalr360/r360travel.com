    ...
    <>
      ...
      <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#161725_0,_#050609_52%)] text-slate-100">
        ...
        <main className="mx-auto max-w-4xl px-4 py-12 md:px-6 md:py-16">
          <h1 className="text-3xl font-semibold tracking-tight md:text-4xl">Terms & Conditions</h1>
          ...
          <div className="mt-10 space-y-8 text-sm leading-relaxed text-slate-300">
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">1. Acceptance of Terms</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">2. Description of Services</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">3. Booking and Reservations</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">4. Payment Terms</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">5. Cancellation and Refunds</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">6. User Responsibilities</h2>
            ...
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">7. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">8. Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">9. Modifications to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">10. Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="mb-3 text-lg font-semibold text-slate-50">11. Contact Information</h2>
              <p>
