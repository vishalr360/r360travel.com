...
export default function HotelsPage() {
  return (
    <>
      <Head>
        <title>Book Hotels, Earn Loyalty Points | Tripsure — Launching Soon</title>
        <meta
          name="description"
          content="Tripsure hotel bookings are launching soon. Book hotels across India and globally — earn InterMiles, Air India One miles, Marriott Bonvoy points and more on every stay."
        />
        <link rel="canonical" href="https://tripsure.com/hotels" />
        <meta property="og:title" content="Hotel Bookings — Earn Loyalty Points | Tripsure" />
        <meta property="og:description" content="Book hotels and earn loyalty points across 25+ programmes. InterMiles, Air India One, Marriott Bonvoy and more. Launching soon on Tripsure." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://tripsure.com/hotels" />
        <meta property="og:site_name" content="Tripsure" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Hotel Bookings — Earn Loyalty Points | Tripsure" />
        <meta name="twitter:description" content="Book hotels and earn loyalty points across 25+ programmes. Launching soon." />
      </Head>
        ...
        <main id="main-content" className="flex-1 flex items-center justify-center px-4 py-20">
          <div className="max-w-2xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#1A1A2E] tracking-tight leading-tight mb-5">
              Book Hotels & Earn<br />Loyalty Points on Every Stay
            </h1>
            <p className="text-lg text-[#64748B] leading-relaxed mb-8 max-w-xl mx-auto">
              Tripsure hotel bookings are coming soon. Search hotels across India and globally,
              earn InterMiles, Air India One miles, Marriott Bonvoy points and 25+ more programmes
              — with automatic BIN-level card tier detection.
            </p>
            ...
            <div className="bg-[#F7F3EC] rounded-2xl p-8 mb-8 text-left">
              ...
              <ul className="space-y-3 text-sm text-[#64748B]">
                <li className="flex gap-3 items-start"><span className="text-[#FF5B24] font-bold mt-0.5">✓</span> 10+ global hotel suppliers — Expedia, Agoda, Hotelbeds, TBO, Ratehawk and more</li>
                <li className="flex gap-3 items-start"><span className="text-[#FF5B24] font-bold mt-0.5">✓</span> Automatic card BIN detection — earn rate shown before you book</li>
                <li className="flex gap-3 items-start"><span className="text-[#FF5B24] font-bold mt-0.5">✓</span> 25+ loyalty programmes — InterMiles, Air India One, Marriott Bonvoy and more</li>
                <li className="flex gap-3 items-start"><span className="text-[#FF5B24] font-bold mt-0.5">✓</span> Access Perks — hotel-funded room upgrades, late checkout, daily breakfast</li>
                <li className="flex gap-3 items-start"><span className="text-[#FF5B24] font-bold mt-0.5">✓</span> Full booking on WhatsApp — no app download required</li>
              </ul>
            </div>
